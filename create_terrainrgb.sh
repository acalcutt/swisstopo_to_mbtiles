...
INPUT_DIR=./download
OUTPUT_DIR=./output
vrtfile=${OUTPUT_DIR}/swissalti3d_terrainrgb_z0-Z17.vrt
mbtiles=${OUTPUT_DIR}/swissalti3d_terrainrgb_z0-Z17.mbtiles
vrtfile2=${OUTPUT_DIR}/swissalti3d_terrainrgb_z0-Z17_warp.vrt
